$(document).ready(function () {
  ...
  var $leadform = $("form#PuneLeadForm"),
    $mLeadForm = $("form#mobile-PuneLeadForm"),
    leadUrl =
      "https://script.google.com/macros/s/AKfycby9M_yNObymM6McXf-1RE2d5EuxT8CI8GM-bVv_ZUEDN15vybVJbb-y/exec";
  ...
  $("#PuneLeadFormSubmit").on("click", function (e) {
    e.preventDefault();
  ...
  $("#mobile-PuneLeadFormSubmit").on("click", function (e) {
